...
const ContentShowcase = () => (
  <section className="bg-[#131c23] min-h-screen flex flex-col justify-start sm:justify-center items-center py-8 sm:py-16 px-4">
    <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-12 items-start">
      {/* RIGHT content - tekst eerst op mobiel */}
      <div className="flex flex-col gap-8 order-1 md:order-none">
        ...
        <div>
          ...
          <p className="text-gray-300 text-base">
            ...
            exciting. Our solutions light up crowds, streamline networking, and
            make events safer, smoother, and more interactive.
          </p>
        </div>
      ...
      {/* LEFT content - image onderaan op mobiel */}
