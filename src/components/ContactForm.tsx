...
const ContactForm: React.FC = () => {
  return (
    <div className="w-full bg-white py-62 px-4 md:px-8">
      <div className="max-w-7xl mx-auto">
        <div className="flex flex-col md:flex-row md:space-x-12">
          ...
          <div className="md:w-1/2 pr-0 md:pr-8 mb-12 md:mb-0 flex flex-col justify-between">
            <h1 className="text-5xl font-bold text-gray-900 mb-6">Power your next event together</h1>
            <p className="text-lg text-gray-700 leading-relaxed mb-8">
              Whether it's a concert, corporate event, or networking meetup, LetsLink helps you harness the power of smart wearables.
            </p>
            ...
            <div className="space-y-6 text-gray-900">
              ...
              <div className="flex items-start">
                ...
                <div className="ml-4">
                  <h3 className="text-lg font-semibold">Kempische Steenweg 303 3500 Hasselt, Belgium</h3>
                </div>
              </div>
          ...
          <div className="md:w-1/2 bg-gray-300 p-12 rounded-xl shadow-md flex flex-col justify-between">
            <h2 className="text-2xl font-bold mb-6 text-gray-800 px-4 md:px-8">Send us a message</h2>
