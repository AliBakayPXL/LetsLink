    ...
    <div className="relative overflow-hidden py-24">
      ...
      <div className="container mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="flex sm:justify-between sm:items-end flex-col sm:flex-row">
          <h1 className="max-w-sm text-[2.5rem] font-bold leading-[3.25rem] text-primary">
            Event solutions for every occasion
          </h1>
          <p className="max-w-md text-[1.125rem] leading-8 text-[#3E4C57]">
      ...
      <div className="container flex justify-center mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 mt-4 sm:mt-16">
        <Link
          to={"/solutions"}
          className="rounded-full bg-[#0D1821] px-10 py-3"
        >
          Event Experiences →
        </Link>
      </div>
